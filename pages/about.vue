...
import Avatar from '@/assets/avatar-revised-blue-bg.png'
...
setMeta('Wanna know more about me? ☺️ - Toshiki')
</script>
...
<template>
	<section class="w-full flex flex-col items-center">
		...
		>
			<h1 class="font-bold text-5xl md:text-7xl text-center font-space tracking-tight">Toshiki</h1>
			<h2 class="mt-4 text-xl md:text-2xl text-center text-gray-500 dark:text-gray-300">Frontend Developer <br /></h2>
			<div class="mt-12 flex flex-col items-center">
				<img :src="Avatar" alt="Toshiki" class="rounded-4xl w-full max-w-96" />
				<div class="info mt-12">
					<div>
						<h5>Basic</h5>
						<p>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
							dolore magna aliqua. Mollis nunc sed id semper risus in. Diam sit amet nisl suscipit adipiscing bibendum
							est ultricies. Congue quisque egestas diam in. Nibh tellus molestie nunc non blandit massa. Vel quam
							elementum pulvinar etiam non quam lacus. Scelerisque eu ultrices vitae auctor eu. Netus et malesuada fames
							ac turpis egestas. Maecenas volutpat blandit aliquam etiam erat velit. Varius morbi enim nunc faucibus a
					...
					<div class="flex flex-col md:flex-row w-full">
						<div class="md:w-1/2">
							...
							<p class="framework text-gray-300 flex flex-wrap text-3xl">
								<IconVue /><IconNuxt /><IconTypescript /><IconVite /><IconTailwind />
							</p>
						</div>
                ...
                <li class="flex mb-2 items-center">
                  <IconTrendUp class="text-gray-300 text-xl mr-2" /> Followers: {{ data?.followers ?? 0 }}
					...
					<div>
						<h5>Contact</h5>
						<ul>
							<li>root@andatoshiki:/~</li>
							<li>hello@toshiki.dev</li>
							<li class="text-gray-300 gap-4 text-3xl flex mt-4">
								<a href="https://github.com/andatoshiki" target="_blank">
									<IconGithub />
								</a>
							</li>
						</ul>
			...
			<!--      </NuxtLink>-->
			<NuxtLink to="/project" class="button-next group my-12">
				Project <IconArrow class="w-6 h-6 duration transition-all ml-2 group-hover:ml-3" />
			</NuxtLink>
		</div>
	</section>
